            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="relative p-6 flex-auto mx-10">
                    ...
                    <div>
                        ...
                        <input name="password" class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs mb-3" id="password" type="password" placeholder="At least 3 characters" required autocomplete="current-password">
